...
void CConfigPanelWidget::createTrackTab()
{
    ...
    lblSize->setStyleSheet("color: #334155; font-size: 12px;");
    ...
    lblSpeed->setStyleSheet("color: #334155; font-size: 12px;");
    ...
    lblHistoryLimit->setStyleSheet("color: #334155; font-size: 12px;");
    ...
    lblHistoryDesc->setStyleSheet("color: #64748b; font-size: 11px; font-style: italic;");
...
void CConfigPanelWidget::createDisplayTab()
{
    ...
    lblOpacity->setStyleSheet("color: #334155; font-size: 12px;");
    ...
    lblTheme->setStyleSheet("color: #334155; font-size: 12px;");
...
void CConfigPanelWidget::createSystemTab()
{
    ...
    lblInterval->setStyleSheet("color: #334155; font-size: 12px;");
